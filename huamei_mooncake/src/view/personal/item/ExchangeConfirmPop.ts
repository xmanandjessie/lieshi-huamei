class ExchangeConfirmPop extends PopView
{
	...
	public setData(data):void
	{
		...
		var bg = new CustomImage("resource/assets/asyn/personal/exchange_confirm.png", true, () => {
		...
		btnSubmit.addEventListener(egret.TouchEvent.TOUCH_TAP,()=>{
			...
			this.data.couponkeyto = this.data.couponkey;
